...
import styles from "./ShopPromo.module.scss";
        ...
        <div className={styles.colText}>
          <div className={styles.textInner}>
            <h2 className={styles.heading}>
              Introducing<br />Cricket Powder
            </h2>
            <p className={styles.copy}>
              Our most celebrated formula — premium 100% finely milled roasted
              cricket powder delivering a complete amino acid profile alongside
              B12, iron, and omega-3s. The simplest upgrade to your morning routine.
            </p>
            <Link
              href="/products/cricket-powder-large"
              className={styles.btn}
            >
              <div className={styles.mask}>
                <span className={styles.slidingText} data-content="Shop Now">
                  Shop Now
                </span>
              </div>
            </Link>
